...
```{r, eval = TRUE, echo = FALSE, out.width = 600, fig.retina = NULL, fig.align  = "center"}
knitr::include_graphics("https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf")
```
...
```{r, eval = TRUE, cache = TRUE, echo = FALSE, fig.width = 6, fig.height= 5, fig.align = "center", warning = FALSE, message = FALSE, out.width = 600}
